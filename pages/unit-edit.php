...
if ( $_POST ) {
	if ( $form->validate() ) {
		...
		if ( $a != 1 ) {
			...
			$db->query( "UPDATE `unit` SET unitname = '{$unitname}' LIMIT 1" );
			header( 'location: unit-edit-remove.php?msg=Данные успешно обновлены!' );
		}
				...
				foreach ( $unit as $unititem ) {
					...
					<form method="post">
						<div class="form-group">
							<label for="unitname">ФИО клиента</label>
